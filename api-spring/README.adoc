...
`src/main/java/attachments/HelloController.java`
[source,java]
----
include::initial/src/main/java/attachments/HelloController.java[]
----
...
== Create an attachments.Application class
Here you create an `attachments.Application` class with the components:

`src/main/java/attachments/attachments.Application.java`
[source,java]
----
include::complete/src/main/java/attachments/attachments.Application.java[]
----
...
`src/test/java/attachments/HelloControllerTest.java`
[source,java]
----
include::complete/src/test/java/attachments/HelloControllerTest.java[]
----
...
`src/test/java/attachments/HelloControllerIT.java`
[source,java]
----
include::complete/src/test/java/attachments/HelloControllerIT.java[]
----
...
* https://spring.io/guides/gs/securing-web/[Securing a Web attachments.Application]
