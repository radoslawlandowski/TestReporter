...
public class TestRunParserFactoryTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
                { ZippedTestRunParser.class, TestRunParserTypes.ZIPPED },
                { RawTestRunParser.class, TestRunParserTypes.RAW }
        });
    }
    ...
    public TestRunParserFactoryTest(Class parser, TestRunParserTypes parserType) {
        this.parser = parser;
